...
\caption[All-optical inverse Compton experiments using a plasma mirror.]{Overview of all-optical inverse Compton experiments using a plasma mirror.}
...
\caption[All-optical inverse Compton experiments using two lasers.]{Overview of all-optical inverse Compton experiments using two lasers.}
...
For this purpose we can use Equation \eqref{Methods:Eqns:BeamLaser_Timing_deltaz} derived in Section \ref{Methods:Sec:Beam_Laser_Timing} to determine the distance $\delta z$ from the intended collision point:
\begin{equation}
