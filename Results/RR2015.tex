...
The blue contour indicates the parameter space most likely to be occupied by interactions correctly described by a quantum model which includes the stochastic nature of emissions in the interaction, derived in the locally constant field approximation \cite{Ritus1985_QRR}. In this model, the electrons follow a classical trajectory between discrete emission events. The contour closely aligns with the semi-classical model as the average emission power is by definition matched. However, at lower final energies, i.e. more intense interactions, the contour starts to separate towards higher critical energies. The finite radiation lifetime allows electrons to propagate unperturbed between different radiation events and to release the equivalent energy within one single emission event. In the astrophysical context this phenomenon is referred to as `energy straggling' \cite{Shen1972_STRAGGLING}. This only occurs when the stochastic nature of the process is considered and leads then to a spectral hardening of the emitted radiation.
