...
The high-energy photons emitted from the two sources characterised in the previous sections have to overlap in time and space in order to interact with each other and to produce electron-positron pairs from the Breit-Wheeler process.
The two lasers driving the photon sources were spatially overlapped to within the width of a thin metal alignment wire $\sim 100\microns$. The laser pulses were then `timed' to each other using a fast photodiode and a suitable oscilloscope such that centres of the $\sim 45\fs$ and the $40\picos$ X-ray heater coincided with each other to an estimated accuracy of $\pm 3\picos$. The typical temporal fluctuations between the two laser arms is typically of orders of few $10's \fs$ with slow long-term drifts of order $\sim 100\fs$ in more extreme cases.  Within the requirements of the system this is not important as the X-ray heater is much longer. The delay of the accelerated electron beam producing the gamma ray flash relative to the driving laser pulse is for a $17.5\mm$ gas target at density XX at most XX. As a result, this is negligible. The X-ray heater is expected to almost instantaneously produce X-rays. As a result the timing for the centre of the laser pulses and the centre of the photon sources is comparable, and timing fluctuations are negligible.
Let us now consider the stability of the spatial overlap. Assuming that the gamma ray beam points on average in the same direction as the laser axis. The size of the gamma ray beam subtracting the blocked signal is divergence times distance. Considering the measured fluctuations, this corresponds to a pointing of XX mm at this plane. The X-ray target emits radiation in a 4 pi sphere. The target is placed 1 mm away from the laser axis. Within the 20 ps upramp of the laser pulse it formed a sphere of radiation of radius c times 20 ps, i.e. XX mm. The pointing of the laser is within micrometres such that this does not change much. As a result it seems that the X-ray target is very large and even significant pointing does not affect the overlap.
