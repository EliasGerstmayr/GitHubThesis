...
In general, thicker targets still transmit a higher yield of gamma rays than their thinner counterparts of the same material. 
The highest transmitted yield is achieved using bismuth of thickness $d = 1\,\mathrm{mm}$, followed by tungsten of $d = 4\,\mathrm{mm}$. 
...
However, the response measured by the gamma spectrometer in the experiment did not change shape measurably over the course of the days, which suggests that the mean energy of the radiation remained stable. 
