...
A photon of energy $E_{ph}$ that is scattered off a relativistic electron is Doppler up-shifted due to the relativistic Lorentz boost. The energy of the scattered photon, $E_{X}$, is given by \cite{Esarey1993_NT}:
\begin{equation}
