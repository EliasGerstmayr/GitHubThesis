...
An $a_0$ of unity indicates that the electric field is of comparable strength as the electron rest mass. An electron in a laser field of relativistic intensity follows a `figure-of-eight' trajectory which results in the emission of higher harmonic radiation.
