...
\begin{figure}
\centering
\includegraphics[width=0.9\columnwidth]{ICUIL-world-map-2019-v6.pdf}
\caption{ICUIL \cite{ICUIL2019_Map}.}
\end{figure}
...
\caption{Laser intensities. Printed with permission \cite{Mourou2019_Nobel}.}
\end{figure}
