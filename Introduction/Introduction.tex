...
The most prominent example taking advantage of this geometry is the seminal E-144 experiment at SLAC, where a 46.6 GeV electron beam was collided with a laser of intensity $a_0 = 0.3$ producing highly energetic gamma radiation \cite{Bula1996_RR} and electron-positron pairs from the nonlinear Breit-Wheeler and the Trident process \cite{Burke1997_RR,Hu2010_TRIDENT}. The increase in available laser intensities and accelerator technologies now provides a motivation to revisit this geometry to probe phenomena in the vicinity of the critical field strength, governed by \textit{strong field quantum electrodynamics} (SFQED).
