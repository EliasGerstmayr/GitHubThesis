...
It turns out that the charge and stability in terms of pointing was the best on the 6th of May.
...
The produced spectrum can be simulated using the electron spectra characterised earlier. GEANT. Typical gamma spectra produced are shown in FIGURE XX. Show that the responses for all electron spectra is fairly similar in simulations and the resulting spectra vary mostly at a low photon level and high energies.
The response of the detector only results in small variations.
Is there a change in relative energy deposited in gamma profile and the entire spectrometer stack?
...
Fitting a shape (exponential spectra) of certain criticial energy.
Put some brightness or so?
...
The response barely changes but the energy spectrum of the gamma rays varies from day to day.
Depending on the day the electron energy is lower and hence the high energy tail will reach higher energies.
