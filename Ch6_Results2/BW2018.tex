...
\begin{figure}
\includegraphics[width=.9\columnwidth]{BW2018_render_V3_annotated.png}
%\includegraphics[width=.9\columnwidth]{BW2018_render_minV1.png}
\caption{Sketch of the full experiment setup and a reduced version relevant for this analysis..}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.9\columnwidth]{2018QED_Converter_YieldVDiv}
...
What is the size of the X-ray source and how large is the gamma beam at that point?
...
The distance from the converter to the interaction point is XX NUMBER. Also consider pointing etc., so better base this on noise and not source overlap. The difference is only 10 percent at 3.4 mm.
