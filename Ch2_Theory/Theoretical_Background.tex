...
We can derive this by calculating the matrix element for the process. This derivation is based on Peskin and Schroeder or Schwartz REF.
...
In more intense interactions several photons can interact at once and are re-emitted as one photon with an integer multiple energy. The normalised vector potential is an indicator of how many photons commonly interact with one electron and the maximum energy then is around
\begin{equation}
...
The Klein-Nishina equation already indicates a headlight effect of the radiation being preferably emitted in forwards direction.
...
\subsubsection{Higher harmonics}
