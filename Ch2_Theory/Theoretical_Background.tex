...
This is based on Alec Thomas' thesis \cite{ThomasThesis}.
...
In CM frame, from \cite{Ribeyre2016_GammaGamma} (Pair creation in collision of gamma-ray beams produced with high intensity lasers) also found in O. Pike's thesis \cite{PikeThesis}
