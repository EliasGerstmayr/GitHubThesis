...
The plasma frequency $\omega_p$ is the natural frequency at which electrons will oscillate in a plasma when displaced and constitutes the typical time scale of the medium. The corresponding plasma wavelength $\lambda_p$ on the other hand constitutes a typical length scale.
\vspace{\baselineskip}
