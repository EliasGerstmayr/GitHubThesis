...
or in terms of the trajectories with $x(0) = 0, z(0) = 0, y(0) = p_\perp/qB = r_{Larmor}$
\begin{subequations}
\begin{empheq}[box=\widefbox]{align}
x(t) &= r_{Larmor} \sin(\omega t)\\
y(t) &= r_{Larmor} \cos(\omega t)\\
