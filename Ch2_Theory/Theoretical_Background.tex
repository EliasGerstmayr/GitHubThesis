...
\EliasComm{What is the difference between radiation reaction and Compton scattering? Radiation reaction is the force acting on the electron influencing its equation of motion. Inverse Compton scattering is a process for which we can calculate the cross section and emission spectrum. Radiation reaction also appears in synchrotrons but there they do not modify the equation of motion in a short time duration. The impact of the change in motion due to an external field is minimal compared to the formation time. Every photon emission from an electron results in a knockback, a transfer of motion conserving momentum and energy. The physics of these processes varies.}
...
\EliasComm{Might not be necessary if I don't really write about BW.}
...
\subsection{A side note: photon-photon scattering}
