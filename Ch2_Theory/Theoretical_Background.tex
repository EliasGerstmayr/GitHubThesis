...
\subsection{The Critical Density (Laser Propagation in Plasma)}
...
\begin{figure}
\includegraphics[width=.5\columnwidth]{feyn_brems.pdf}\includegraphics[width=0.5\columnwidth]{brems_classical.pdf} 
