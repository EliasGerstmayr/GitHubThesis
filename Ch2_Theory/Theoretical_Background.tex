...
After a certain distance, the depletion length $pd$, the pulse is not intense enough any more to drive a stable wave with sufficient field gradients - the cavity collapses:
\begin{equation}
