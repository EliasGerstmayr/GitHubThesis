...
The cross section can be easily calculated by re-using the result for the Compton cross section we derived earlier. Both Feynman diagrams are very similar and the cross-sections can be related by making use of crossing symmetries.
...
This might explain why the linear Breit-Wheeler process is the only fundamental QED tree-level interaction that has not been observed yet in an experiment.
...
It has been observed in the 90s at SLAC in the interaction of a 46.6 GeV electron beam with a laser of intensity $10^{17}\,\mathrm{W cm^{-2}}$
