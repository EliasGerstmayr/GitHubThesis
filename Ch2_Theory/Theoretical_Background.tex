...
\begin{equation}
a_0 = 0.856 \sqrt{\frac{I [W/cm^2] \lambda^2 [\mu m^2]}{10^{18} W/cm^2 \mu m}}.
\end{equation}
...
Combining our knowledge of the electric field, which increases with density, and the limiting factors for the acceleration length dephasing and depletion, which decrease with density, the maximum energy gain $W_{max}$ for a 3D non-linear wake is given by \cite{LuThesis,Lu2007_3DWAKE}
\begin{equation}
