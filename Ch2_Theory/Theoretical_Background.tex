...
\begin{equation}
\boxed{P_c = \frac{8\pi \epsilon_0 m^2_e c^5}{e^2} \frac{\omega^2}{\omega^2_p} \approx 17.5 \frac{\omega^2_0}{\omega^2_p} \,\mathrm{GW} = 17.5 \frac{n_c}{n_e} \, \mathrm{GW},}
\end{equation}
...
The electromagnetic fields associated to the cavity are given by \cite{Kostyukov2004_BUBBLEFIELDS}
\begin{align}
...
\end{equation}
with $\alpha$ the fraction of energy contained in the \textsc{fwhm} of the laser focal spot, $P$ the laser power. $P_c$ is the laser power at which relativistic self-focusing and diffraction are balanced, with $P_c \approx 17.5 n_c/n_e\,\mathrm{GW}$ (see Section \ref{Theory:Sec:SelffocusingSelfguiding}).
