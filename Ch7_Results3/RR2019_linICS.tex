...
\caption{Examples of electron spectra measured in the experiment. The y-axis is the dispersion axis and shows the energy, the x-axis indicates the divergence. The colour scale indicates the amount of charge in the beams and is fixed for all plots.}
...
\caption{Example of an electron spectrum. The to the electron energies corresponding gamma-ray energies are indicated in a second x-axis on the top.}
\end{figure}
