...
\begin{equation}
\boxed{ \frac{\int E_{dep} (\gamma) \frac{\mathrm{d}N_e}{\mathrm{d}\gamma}\gamma\mathrm{d}\gamma}{\int E_{dep} (\gamma)\frac{\mathrm{d}N_e}{\mathrm{d}\gamma}\mathrm{d}\gamma}  \approx \langle \gamma \rangle.}
\end{equation}
