...
A scintillating LANEX screen placed just after the window measures the spectrum with very little scattering from the window due to the short drift distance. This is $1.61\,\mathrm{m}$ from the interaction point. A second LANEX screen measures the spectrum $700\,\mathrm{mm}$ further downstream and can be used to account for pointing of the beam.
