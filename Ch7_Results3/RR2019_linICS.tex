...
\begin{figure}
\centering
\includegraphics[trim={1cm 0 1cm 0}, clip, width=1.0\columnwidth]{Example_Espec_ICS_V2.png}
...
Using this Equation we estimate for the conditions in the experiment ($E_J = 9.73\pm0.15$,$Q=239\pm92\,\mathrm{pC}$ and $r=200\,\mathrm{\upmu m}$) that $(1.3 \pm 0.5) \times 10^{7}$ photons are scattered. This is of similar order of magnitude as reported for bright betatron sources \cite{Kneip2010_BETATRON} CHEN BETATRON REF\addref, where we can assume a comparable pulse duration and source size as these parameters are determined by the electron beam properties (REF\addref). In our previous analysis, however, we have shown that we expect to measure 1000-times higher photon energies due to the Lorentz boost. We expect that we are able to measure this order of magnitude of photons in this energy range.
\vspace{\baselineskip}
...
\begin{figure}
\centering
\includegraphics[trim={1cm 0 1cm 0}, clip, width=1.0\columnwidth]{Example_Espec_ICS_Edep_V2.png}
