...
Over the course of a 484 shot dataset the maximum energy of the electron beam is about $910\pm177\,\mathrm{MeV}$ with some beams reaching up to 1.3 GeV. 
...
\begin{figure}
\centering
\includegraphics[trim={4.8cm 0 5cm 0}, clip, width=1.0\columnwidth]{Charge_MaxE_Histograms.png}
\caption{Electron properties histogram.}
\label{linICS:Figs:Elec_histogram}
\end{figure}
The charge of the beam varies in particular due to the varying length of the bunch (spectrally) at $202 \pm 100\,\mathrm{pC}$.
