...
We are interacting relatively far into the channel and the pointing of the beam still develops. In particular the total integrated beam is used to indicate the pointing which can change due to oscillations.
