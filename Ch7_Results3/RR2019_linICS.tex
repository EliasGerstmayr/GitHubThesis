...
Over the course of a 326 shot dataset the maximum energy of the electron beam is about $915\pm177\,\mathrm{MeV}$ with some beams reaching up to 1.3 GeV. 
...
The divergence of the beam is XX PM XX.
...
The electron beams shown above were collided with at an intensity of $a_0 < 0.3$, which is sufficiently below 1.
This means the interaction is predominantly linear and we can estimate the emitted radiation to be described by the following equation:
...
To reach 400um, we have to propagate 800um, so of order 100 $z_R$ and we are definitely in the near field of the laser and we have a smooth flat-top.
...
... profile tells us about spatial things
...
... if FWHM is related, use the data in x-axis to estimate range of energies.
