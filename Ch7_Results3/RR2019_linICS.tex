...
Using this Equation we estimate for the conditions in the experiment ($E_J = 9.73\pm0.15$,$Q=239\pm92pC$ and $r=200um$) that $(1.3 \pm 0.5) \times 10^{7}$ photons are scattered. This is of similar order of magnitude as reported for bright betatron sources (REF REF Chen and Kneip), but from the previous section we expect to reach 1000-times higher photon energies due to the Lorentz boost. Since pulse duration comparable, this means brightness is higher.
...
Absolute calibration using Cs137 source.}
