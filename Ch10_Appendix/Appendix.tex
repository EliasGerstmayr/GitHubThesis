...
decay time
material
conversion energy to photons for X-rays and particles
Fast scintillators and slow scintillators (gating noise)

Coating and collection efficiency
...
Slow scintillation, with 0.6 microsecs to 3.5 microsecon components.
