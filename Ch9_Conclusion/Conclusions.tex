...
\item  on-shot timing, as done at Gemini \cite{Shalloo_GEMINIDRIFT}
\item  Shock injection to fix laser-electron offset.
\item  Finding alignment using raster scan as described in Chapter \ref{Chap:linICS}
\item  outside plasma, other effects like fringes or plasma afterglow to consider?
\end{itemize}
