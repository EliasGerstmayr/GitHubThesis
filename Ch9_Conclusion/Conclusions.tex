...
spatial interferometry at TCC \cite{Cole2018_RR}

spectral interferometry at TCC \cite{Corvan2016_TIMING}

on-shot timing, as done at Gemini \cite{Shalloo_GEMINIDRIFT}

Shock injection to fix laser-electron offset.

Finding alignment using raster scan as described in Chapter \ref{Chap:linICS}
