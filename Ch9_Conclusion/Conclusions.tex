...
\begin{itemize}
\item In Chapter \ref{Chap:linICS}, relativistic electron beams with energies up to $1.3\,\mathrm{GeV}$ from shock injection were collided with laser pulses at $a_0 \sim 0.3$ over 100s of shots, producing radiation from linear inverse Compton scattering of variable spectral shape in the range of 10s of MeV photon energies. 
A procedure to align and overlap the laser and electron beam and maintain the alignment over extended periods of time was developed. Linear inverse Compton scattering in conjunction with a gamma profile screen were considered as non-invasive electron beam diagnostics.
...
\item In Chapter \ref{Chap:BW}, electron beams from ionisation injection (gas cell) were propagated through a metal foil to produce highly-energetic bremsstrahlung. The performance of the bremsstrahlung source was optimised in terms of collimation, yield and noise. The gamma-rays were used in conjunction with a laser-driven X-ray source to attempt the production of electron-positron pairs from the linear Breit-Wheeler process in a pure photon-photon collider setup. The variations of the bremsstrahlung and X-ray source on the total Breit-Wheeler cross section and the implications for future experiment setups were discussed.
\end{itemize}
...
\cite{Cole2018_RR,Behm2018_Gamma} \cite{Lisi2018_Gamma}
...
\EliasComm{Outlook: LCFA, Narozhny conjecture!}
\EliasComm{Motivate again what the difference is we can make in contrast to conventional accelerators at this stage and measurements in crystals (limited non-linearity, LCFA might break down differently).}
...
\begin{itemize}
\item Focusing geometry
\item polarisation
\item Targetry and injection
\item Diagnostic for laser
\item Diagnostic for plasms
\end{itemize}
