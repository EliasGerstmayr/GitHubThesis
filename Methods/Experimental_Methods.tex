...
The gas is stored in a reservoir at backing pressures between $70$ and $100\,\mathrm{bar}$, and is released through a Peter-Paul solenoid valve (EH22). 
...
Gas cell targets have sometimes produced superior results from gas jets using the same laser system, e.g. \cite{Kneip2009_GEV} v \cite{PoderThesis},  in terms of charge, shot-to-shot stability \cite{Osterhoff2008_CELL,Desforges2014_CAPILLARY} and maximum energy gain.
...
The alignment of gas cells, on the other hand, requires more precision as otherwise parts might be damaged and in turn deteriorate the performance. Large pointing fluctuations of the laser can in addition cause damage, in particular at the entry and exit of the cell where plasma might defocus the laser pulse.
