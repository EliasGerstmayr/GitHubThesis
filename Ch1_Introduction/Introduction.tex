...
\EliasComm{Radiation sources. Conventional accelerators include: PETRA III, ESRF, SPring-8, SLS, APS, NSLS II, SLS, BESSY, FLASH, FERMI, LCLS, SACLA, LCLS SEEDING, Gemini experiments betatrons, hard betatron radiation, linear ICS results, non-linear ICS, bremsstrahlung source, X-ray source, synchrotron, undulator.}
