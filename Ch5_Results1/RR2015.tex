...
\begin{figure}
\centering
\includegraphics[trim={4.8cm 0 5cm 0}, clip, width=.9\columnwidth]{ElecEdge_Example.png}
...
The following analysis is based on Jason Cole's work for \cite{Cole2018}.
