...
In addition, the high photon energies offer the opportunity to directly measure the effect of radiation reaction on the beam dynamics itself and to observe energy loss, if the emitted photon carries an energy comparable to the energy of the electron $\gamma^2 a_0 \frac{2 r_e \omega}{3c} \sim 1$ \cite{Albert2016_APP}\addref. Classical descriptions of radiation reaction exhibit unphysical predictions like self-acceleration, resulting in runaway solutions, or an unbounded emission spectrum, i.e. energy loss higher than the initial energy of the electron is allowed (REF\addref). A universally accepted description of radiation reaction has not been found yet (REF\addref).
...
Powers et al. & 2014 & XX & XX & XX\\
Khrennikov et al. & 2015 & XX & XX & XX\\
Tsai et al. & 2015 & 90 & 1.2 & 0.18\\
Shaw et al. & 2017 & 2000 & XXX & 85\\
\hline
\end{tabular}
}
...
\hline \hline
\textbf{Name} & \textbf{Year} & $\bm{\epsilon}$ \textbf{[MeV]} & $\bm{a_0}$ & $\bm{\epsilon_\gamma}$ \textbf{[MeV]}\\ \hline \hline
Chen et al. & 2013 & XX & XX & 1\\
Liu et al. & 2014 & 450 & XX & 9\\
...
The Chapter continues with an analysis of the measured electron spectra of this dataset. The electron spectra consistently exhibit a distinct spectral feature in shape of a sharp edge-like fall-off in charge at $\sim 550\,\mathrm{MeV}$. The intrinsic fluctuations of the electron source are characterised in a statistical analysis after removing correlations.
