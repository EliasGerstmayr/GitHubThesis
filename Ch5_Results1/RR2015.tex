...
\EliasComm{This section is quite old and should be mostly replaced by the Overleaf document I prepared for the RAL report. Most of the numbers are in there as well, in particular on the electron statistics as well as up-to-date drawings.}
...
Other parts of the analysis, in particular the retrieval of the gamma spectrum of the inverse Compton signal, were performed by Jason Cole and will be indicated as such in the course of this chapter.
...
The first part of the experiment is typical a LWFA setup. The laser beam is focused by an f/40 spherical mirror with focal length 6 m onto the leading edge of a 15 mm conical supersonic helium gas jet target. Electrons are accelerated via laser wakefield acceleration (LWFA) and propagate further downstream in the direction of the laser propagation. The typical \textsc{fwhm} focal spot size of the driving laser pulse was $37 \times 49 \,\mathrm{\mu m}$ with an energy on target of around $(8.6 \pm 0.6)\,\mathrm{J}$, which corresponds to $a_0 = 1.9 \pm 0.1$. The electron density of the target was around $(3.7 \pm 0.4) \times 10^{18} \,\mathrm{cm}^{-3}$.
\vspace{\baselineskip}

The second beam is focused down tightly onto the opposite edge of the gas jet using an f/2 off-axis parabola to scatter from the bunch of electrons accelerated by the first laser, generating a bright burst of gamma rays from inverse Compton scattering (ICS). The energy on target was typically $(10 \pm 0.6)\,\mathrm{J}$ focused into a spot of FWHM size of $2.4 \times 2.8\,\mathrm{\mu m}$, corresponding to peak $a_0 = 24.7 \pm 0.7$. As this beam counter-propagates with the electron bunch, the focusing optic lies in the beam path of the first beam and the electron trajectory. In order to enable their propagation a hole, several $\mathrm{mm}$ in diameter, was added in the centre of the parabola used for the North beam. This leads to a decrease in intensity of the beam of around $16\%$.
\vspace{\baselineskip}
