...
The following analysis is based on Jason Cole (Imperial College) for \cite{Cole2018_RR}.
...
\caption[]{Conceptual sketch of the experimental setup as used on the radiation reaction campaign \cite{Poder2018_RR}. Adapted from Figure XX in \cite{Cole2018_RR}.
...
The characteristic number assigned to each spectrum is the cut-off energy, which is as in \cite{Poder2018_RR} defined as the energy at which the spectral intensity reaches 10 percent of its peak value.
\vspace{\baselineskip}
...
\caption[]{.}\label{RR:fig:a020_matrix}
\end{figure}
