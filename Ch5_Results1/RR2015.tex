...
\begin{equation}
S_{total} = S_{BG} + S_{ICS} = c_{BG} \int  (\mathrm{d}N_e /\mathrm{d}\gamma)\, \gamma^2 \mathrm{d} \gamma + c_{ICS} a_0^2  \int ( \mathrm{d}N_e /\mathrm{d}\gamma)\, \gamma^2 \mathrm{d} \gamma,
\end{equation}
