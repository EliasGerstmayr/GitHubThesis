...
\subsubsection{General merits of ICS}
In relativistic inverse Compton scattering (ICS) one (linear) or multiple photons (non-linear) scatter from a relativistic electron. The scattered photons experience a relativistic Doppler-shift and are re-emitted in a narrow cone in the direction of the electron propagation carrying a higher energy based on the electron energy and the intensity of the laser field. The emitted photon energy, $E_{photon}'$, is maximised in a head-on collision: $E_{photon}' \sim 4 \gamma^2 E_{photon}$ (see Theory REF for further details). Higher electron energies result in a stronger shift of the radiation, leading to a hardening of the spectrum and an increase of the corresponding energy loss the electrons experience (REF). A more intense laser field ($a_0 > 1$) enables non-linear interactions and increases the number of photons interacting at once with an electron (REF), resulting in the generation of $\sim a^3_0$ higher harmonics but also redshifting and broadening of the spectrum. As a result the rapidly increasing number of higher harmonics blend together to form a broadband synchrotron-like spectrum.

This provides a promising route to generate bright burst of high energy radiation reaching 100's of keV or even MeV photon energy, suitable to image high-Z objects and stimulate nuclear transitions, even at small-scale facilities.
In addition, the high photon energies offer the opportunity to measure the effect of radiation reaction, if the emitted photon carries an energy comparable to the energy of the electron.

Over the past years, groups linked to LWFA research have in particular investigated the merits of ICS as at these laser facilities a relativistic electron beam and an intense laser is conveniently housed together, and both are `intrinsically' timed to each other.
\vspace{\baselineskip}

\subsubsection{ICS using LWFA}
Colliding-pulse or ICS experiments using LWFA have been successfully performed by different groups over the past years, gradually improving the control over the process, increasing the energies of the electrons and the laser intensities involved, and subsequently the radiation generated \cite{TaPhuoc2012a,Chen2013a,Khrennikov2015,Powers2014,Sarri2014}.
The energy of the produced radiation is a good indicator for the continuing progress of these experiments. More specifically of interest for measuring radiation reaction is the quantum non-linearity parameter, $\eta = 2\gamma E_L/E_{crit}$, that indicates the strength of the electric field of the photon in the rest frame of the electron relative to the critical electric field of QED, $E_{crit}$.
\vspace{\baselineskip}

\subsubsection{ICS with tape}
Most frequently, a single laser pulse is used to accelerate electrons to relativistic energies and to scatter the electrons after reflecting the beam from a plasma mirror (e.g. tape \cite{TaPhuoc2012a}). In such a setup the laser beam and the electrons are timed intrinsically. A close to normal overdense plasma surface will then be able to overlap the laser beam and the electron bunch spatially. In \cite{TaPhuoc2012a} electrons of an energy $\sim 100\,\mathrm{MeV}$ were collided at a laser intensity of $a_0 \approx 1.2$ (mildly non-linear). The radiation measured was a broadband X-ray spectrum and reached up to $100'\mathrm{s}\,\mathrm{keV}$ photon energies. A lower electron energy spread and tunability was demonstrated at slightly lower electron energies and laser intensities in \cite{Powers2014} and\cite{Khrennikov2015}. By now the highest recorded gamma-ray energies from ICS in LWFA using this scheme have been achieved by Shaw et al. (REF) reaching up to 85 MeV in a collision with electrons at energies up to $2\,\mathrm{GeV}$.
\vspace{\baselineskip}
...
\subsubsection{ICS with two lasers}

If, however, two separate lasers are available or one very intense laser that can be split into two parts, one can be used to accelerate electrons and one to scatter off them. This offers the opportunity to achieve higher intensities and electron energies at the interaction, and more control over the interaction itself. However, it is challenging to overlap the micron-sized electron bunch with the ultra-short laser pulse, probably focused down tightly to a micron-scale focal spot as well to achieve high intensities, in other words tightly compressed in time and space, and to maintain this alignment over an extended period of time.
...
\subsubsection{ICS via LWFA in the future}

Future laser facilities promise interactions .... PW, with SULF aiming for a 100 PW system.
Strongly non-linear, quantum regime, photon-photon collider, BW, Schwinger limit.
Current LWFA energies for electrons of order 4 GeV (Korea) and guided up to almost 10 GeV.
Limitations of all-optical ICS. GUILLERMO REF.
...
\subsubsection{This work/chapter}

The work presented in this chapter relates to an ICS experiment performed at the Astra-Gemini laser facility in late 2015 that succeeded in colliding electrons of $\sim 550\,\mathrm{MeV}$ energy at a laser intensity of $a_0 \approx 10$, reaching critical gamma-ray energies in excess of $30\,\mathrm{MeV}$. This was the highest gamma-ray energy from an all optical ICS source published at that point and consists the first published measurement of radiation reaction in an LWFA setup (REF PRX Cole). 


In large parts the content of this chapter outlines the work the author contributed to this publication, in particular the analysis of electron spectra and their characterisation. As a result, the reader will find many parallels between PRX COLE and this chapter, and a similar line of arguments. 
Other parts of the analysis, in particular the retrieval of the gamma spectrum of the inverse Compton signal, were performed by Jason Cole (Imperial College London) and Keegan Behm (University of Michigan). Details of the method can be found in KEEGAN REF or also in the Methods chapter of this thesis. Their contributions and work will be acknowledged and indicated as such in the relevant parts of this chapter.


Finally, the author compares these results with a second measurement of radiation reaction at higher electron energies performed a the same laser system. Electrons of around $2\,\mathrm{GeV}$ energy were collided at similar intensities $a_0\sim 10$ but lack a spectral measurement of the gamma rays to complete the picture. The results of this campaign have been published in (REF Poder). In particular, the author will compare the stability of the electron energy and the stability of the electron spectrum to draw conclusions for future experiments and indicate which parameters and scale of data points would be required to distinguish different models of radiation reaction with statistical significance. This discussion is continued more extensively and in more detail in C ARRAN REFS.
...
Based on a sketch made by J. Cole (Imperial College) and adapted for this work and found similar in REF SPECTROMETER. 
...
The collimated cone of gamma rays propagates without perturbation through the hole of the f/2 OAP, the aperture of the dipole magnet, finally through a $50\,\mathrm{mm}$ aluminium laser beam block and a $250\,\mathrm{\mu m}$ thick kapton vacuum window into air. There the gamma rays are incident onto a stack of caesium-iodide (CsI) crystals that measures the spectrum of the high energy radiation. The stack is 33 crystals high and 47 crystals deep, each crystal $5\,\mathrm{mm} \times 5\,\mathrm{mm} \times 50\,\mathrm{mm}$, where the small faces are oriented in transverse direction and are imaged by an Andor iXon camera. The crystals are spaced by $1\,\mathrm{mm}$ aluminium dividers and the front side of the stack is covered by a $9\,\mathrm{mm}$-thick steel plate. The entire stack is housed within a lead enclosure with a circular aperture of  XX NUMBER.
\vspace{\baselineskip}

The two laser beams are overlapped in space and time using spatial interferometry: a reflective 90-degree knife-edge prism is placed at the interaction point and reflects both counter-propagating laser beams collinearly onto a CCD camera chip equipped with a x10 microscope objective. The laser beams are cross-polarised and hence a polariser is needed to enable interference but also gives control over the relative brightness over the beams. The different radii of curvature of the f/40 and f/2 beams result in the formation of circular interference fringes when the laser pulses overlap in both space and time. Once the fringes appear, their visibility can be optimised further to increase precision. The precision of the pulse overlap is around $\pm 30\,\mathrm{fs}$. Unfortunately, the overlapping the beams both in time and space at one point in time does not guarantee that they remain overlapped. Some studies performed at Gemini (by Oxford REF) indicate that drifts exist in the system and the necessary precision of the alignment is only maintained for about half an hour. This has been greatly improved in recent years on other experiments. In addition, the precision of the prism position determines how accurately the interaction point is defined.
\vspace{\baselineskip}
...
A detailed description of the treatment of the raw data (background subtractions, image transformations, tracking etc.) can be found in the Methods section and are not expanded here.

\subsubsection{General description of electron spectrum and finding the edge}

A typical electron spectrum measured on the experiment and a lineout are shown in Figure \ref{fig:Cole_espec_example}. 
...
The high energy electrons are consistent with self-injection (REF), whereas the high charge component with the distinct spectral feature is consistent with shock injection caused by damage to the gas nozzle (REF). The shock fronts are visible on an optical image seen in ADD PRETTY PIC PHOTO along with the damage on the nozzle.
...
In addition to radiation from ICS produced in the interaction of electrons and laser photons, the dispersed electrons interacting with matter in their trajectory, particularly high-Z materials such as the vacuum chamber walls, emit broadband bremsstrahlung. The radiation is in a spectral range comparable with the expected inverse Compton signal and is also measured by the gamma-ray detectors. The bremsstrahlung is produced mainly off-axis and a large fraction can be efficiently shielded by blocking the direct line of sight with sufficient lead shielding. The remaining signal is expected to follow a scaling proportional to the energy and charge of the electron bunch. Interactions of electrons that produce bremsstrahlung follow a $\gamma^2$ relation for the total energy of the emitted radiation. Assuming that the energy of the radiation is proportional to the energy deposited and the scintillating signal (REF OR XSEC) we expect the following relation for the detected bremsstrahlung signal, $S_{BG}$:
\begin{equation}
S_{BG} = c_{BG} \int \mathrm{d}N_e /\mathrm{d}\gamma\,\gamma^2 \mathrm{d}\gamma = c_{BG} Q \left\langle \gamma^2 \right\rangle,
\end{equation}
where $c_{BG}$ is a constant that encapsulates all the complicated details such as conversion efficiencies of electron energy to photons, photons depositing their energy in the crystals, energy to scintillator photons, viewing angle, collection efficiency, quantum efficiencies and so on. $\mathrm{d}N_e/\mathrm{d}\gamma$ is the charge distribution of the measured electron spectrum, $Q = \int \mathrm{d}N_e/\mathrm{d}\gamma \mathrm{d}\gamma$ the total charge and $\gamma$ is the Lorentz factor of the electrons. 
\vspace{\baselineskip}
...
\EliasComm{Add image of stack}

Figure \ref{Results:Figs:NullColl:DeltaCsIVsSigmaE2+CsIVsE2} shows the relation of $Q \left\langle\gamma^2\right\rangle$ to the total detector signal (COUNTS XX). The total detector signal here is the total number of pixel counts on the background-subtracted image in the relevant apertured area of the stack as seen on Figure XXX NUMBER ADD PIC. The data points relating for shots without a scattering beam (in blue) seem to follow the expected linear trend, with $c_{BG}$ XX NUMBER. The correlation coefficient for the data has a value of XX NUMBER PM NUMBER. 
\vspace{\baselineskip}

On shots with the scattering beam on and if the collision is successful, we expect the second beam to produce a burst of gamma rays from inverse Compton scattering. At the detector we expect to measure a combined signal of bremsstrahlung background and the ICS signature. The emitted energy of the ICS radiation and hence the produced detector signal, $S_{ICS}$, is proportional to $\gamma^2$ similarly as for bremsstrahlung but also scales with the normalised vector potential (REF PRX THOMAS 2012, CORDE REV MOD 85, 2013):

\begin{equation}
S_{ICS} = c_{ICS} a_0^2  \int  \mathrm{d}N_e /\mathrm{d}\gamma\, \gamma^2 \mathrm{d} \gamma,
\end{equation}

and the potential combined signal, $S_{total}$, would then accordingly be:

\begin{equation}
S_{total} = c_{BG} \int  \mathrm{d}N_e /\mathrm{d}\gamma\, \gamma^2 \mathrm{d} \gamma + c_{ICS} a_0^2  \int  \mathrm{d}N_e /\mathrm{d}\gamma\, \gamma^2 \mathrm{d} \gamma,
\end{equation}
where now $c_{ICS}$ encapsulates all the complex physics of coupling constants, cross sections and so on. In this case $c_{ICS}$ is strictly speaking not a constant as the conditions of the interaction vary strongly due to the changing overlap of the laser pulse and the electron beam. The better the overlap and the higher the intensity at that interaction, the stronger the ICS signal and the easier to distinguish from the background Bremsstrahlung it will be. In addition, whilst we expect all of the electrons to produce bremsstrahlung, only a variable fraction of electrons will interact with the laser pulse.
\vspace{\baselineskip}
...
In figure NUMBER PLOT FOR SIGNAL ABOVE... we now see the shots lined up with their actual shot number versus the CsI signal above the expected signal from the bremsstrahlung background. The y-axis now encapsulates the information of the gamma signal and the electron spectrum.
...
To put an accurate number on the energy loss we have to take into account the intrinsic variations of the electron source. In this section the author will present a statistical analysis of the shots without the scattering beam on, characterising the typical electron spectrum and the extent of its fluctuations. These shots will be from now on referred to as reference data or null shots. This is crucial to separate the energy loss of the electron beam from the variations of the source itself.

The set of electron spectra presented in Figure XX NUMBER was taken as immediate reference data for the two-beam interactions. This data set is relatively limited to 23 shots, 10 of which are reference data.
...
In contrast to the 10 reference shots where the scattering beam was turned off, the subsequent shots had at any point both beams on. However, using the gamma-ray signal as indication for overlap, we selected shots that very closely (within one standard deviation) matched the expected trend of bremsstrahlung and made a new data set based on these reference shots. A significant interaction that would modify the spectrum would result in significant amount of additional radiation. This new data set consists of additional 89 shots. 
\vspace{\baselineskip}
...
Geant simulations and so forth.
...
A paper on the design of the detector and the analysis of the spectrum has been published (REF Keegan paper).
...
In this experiment the models were not distinguishable. A second measurement was taken in Poder et al. but without measurement of the spectrum.
Comparing the stability of the sources to indicate whether a gas cell is more suitable in the future than a gas jet. Shock injection versus self injection.
...
\caption[]{Conceptual sketch of the experimental setup as used on the radiation reaction campaign \cite{Poder2018} 
...
Both lasers were synchronised to about $40$ fs accuracy using spectral interferometry as described in more detail in (REF CORVAN).
\vspace{\baselineskip}
...
It looks like the gas cell is a better target and the energy dependencies can be easier related to laser energy etc. If the shock injection would be improved a stable injection point would be key to maintain interaction conditions. Using profile and spectral measurements together.

In this case the gas jet was inferior in terms of stability but C ARRAN indicates that we require low energy spread beams. Literature shows that these are achievable through shock injection. Ideally a more stable low energy spread beam would be suited to discriminate quantum and non-quantum models.

\section{Conclusion}

\subsubsection{Radiation Reaction}

Radiation reaction was measured in an all-optical setup for the first time by colliding a relativistic electron beam from LWFA with a tightly focused laser beam of $a_0 \approx 10$. 

Could not distinguish different models but measured radiation reaction.

Beam quality to be improved.
