...
\fi
The entire stack is housed and shielded in a lead enclosure with a circular aperture of $15\,\mathrm{mm}$ diameter, corresponding to an acceptance angle of $\sim 0.7\,\mathrm{mrad}$ at $\sim 2.2\,\mathrm{m}$ from the interaction point.
\vspace{\baselineskip}
...
\caption[]{Example of a typical electron spectrum. The in dispersion and divergence axis integrated spectrum is shown on the respective axes. ROTATE image in Matlab to make sure the axes are readable.}
