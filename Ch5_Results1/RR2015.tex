...
Another measurement of radiation reaction was performed at the LHC \cite{Wistisen2018_RR}, however using positrons and planar channeling in crystals (REF) as tool to probe radiation reaction \cite{DiPiazza2017_CrystalRR} instead of ICS.
