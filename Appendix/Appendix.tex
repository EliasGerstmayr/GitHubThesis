...
$\lambda$ & wavelength\\
$\omega$ & frequency\\
$\eta$ & quantum nonlinearity parameter\\
$R_c$ & classical radiation reaction parameter\\
$\gamma$ & relativistic Lorentz factor\\
$E$ & Energy, e.g. $E_\gamma$ gamma energy\\
...
Symbol & Name & Value (SI) & Unit \\ \hline \hline
$\alpha$ & fine-structure constant & & one\\
$c$ & Vacuum speed of light & $3$ & $\mathrm{m/s}$ \\
$m_e$ & electron mass & & $\mathrm{kg}$\\
$e$ & electron charge & & $\mathrm{C}$\\
$r_e$ & electron radius & & \\
...
$\lambda_C$ & Compton wavelength & & \\
$\bar{\lambda_C}$ & reduced Compton wavelength & & \\
$\tau_C$ & Compton time & & \\
$E_S$ & Schwinger field & &
\end{tabular}
...
Quantities with a bar are reduced quantities $\hbar = h/2\pi$.
...
bar & reduced quantity, i.e. divided by $2\pi$\\
...
The electrons oscillate at the betatron frequency $\omega_\beta$ \cite{WoodThesis}
\begin{equation}
