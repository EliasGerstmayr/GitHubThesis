...
\caption{List of abbreviations used in this work.}
\end{table}
\clearpage
...
\caption{List of notations used in this work.}
\end{table}
...
\end{equation}
where $x = \epsilon/k$, where $k$ is the incident photon energy and $\epsilon$ the energy of the produced electron or positron. $A$ is the atomic weight and $N_A$ the Avogadro constant.
