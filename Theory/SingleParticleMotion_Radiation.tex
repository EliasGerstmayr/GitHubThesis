...
\caption[Angular energy distribution as a function of electron energy and redshifting of radiation as a function of $a_0$.]{Left: Energy of the emitted radiation relative to the peak energy, $E_0$, as a function of the observation angle $\theta$ for different electron energies (legend). Right: Decrease in the peak photon energy (redshifting) relative to the peak photon energy in the limit $a_0 \rightarrow 0$ as a function of $a_0$ (right).}
