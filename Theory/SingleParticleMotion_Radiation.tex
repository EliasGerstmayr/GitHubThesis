...
\eta = E_{RF}/E_{crit},
\end{equation}
with the critical field for quantum electrodynamics $E_{crit} \approx 1.38 \times 10^{18}\,\mathrm{V m^{-1}}$ \cite{Sauter1931_ECRIT,Heisenberg1936_ECRIT}.
...
\end{cases}
\end{equation}
$\chi = \hbar \omega E_L/2 m_e c^2 E_S$ is a quantum parameter, with the electric field of the laser, $E_L$, and the Schwinger field, $E_S = 1.38 \times 10^{18} \,\mathrm{V m^{-1}}$.
...
\begin{equation}
\boxed{E_S = \frac{m^2_e c^3}{e \hbar} \approx 1.36\times 10^{18}\,\mathrm{V m^{-1}}},
\end{equation}
