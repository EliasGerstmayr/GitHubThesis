...
The classical radiation reaction parameter, $R_c$, for instance, indicates how much energy is radiated in a single cycle relative to the electron energy in the average rest frame, $f = E_{rad}/(\gamma' m) = 4\pi R_c/3$. $R_c$ is in natural units and in terms of experimental variables given by \cite{DiPiazza2010_QRR,Blackburn2019_RRReview}:
\begin{subequations}
\begin{empheq}[box=\widefbox]{align}
