...
The plasma frequency, $\omega_p$, is the natural frequency at which electrons will oscillate in a plasma when being displaced \cite{Kruer}. It constitutes the typical time scale and the corresponding plasma wavelength, $\lambda_p$, the typical length scale of the medium.
\vspace{\baselineskip}
...
\caption[Plasma frequency and wavelength as function of plasma density.]{Plasma frequency (blue) in Hz and wavelength (red) in micrometres as function of plasma density.}
