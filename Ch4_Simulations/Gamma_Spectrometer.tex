...
\subsubsection{Resolving spatial dimensions}
...
\EliasComm{What did I used for BW? Probably bismuth etc.}
...
In a naive attempt electrons of a range of energy were simulated in an interaction with 1 mm aluminium and the detector response was recorded. The 
combined response based on the electron spectra measured did not align in any way with the simulations. This indicates that the noise production and directionality are more complicated. 

Instead a range of non-collision or other radiation source shots was selected and their experimental response measured. Their total brightness scales linearly with QE2 of the electrons measured. In case of linear ICS the spectrum is unperturbed.
