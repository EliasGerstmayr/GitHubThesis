...
A review \cite{Downer2018_DiagnosticReview}
...
On the other hand, this also gives control to add aberrations and tailor the wavefront to specific applications that might benefit from this, e.g. astigmatism for radiation reaction \cite{Baird2019_RR}, wavefront tilt for betatron radiation (REF Mangles).
\vspace{\baselineskip}
...
Gas cell targets have sometimes produced superior results from gas jets using the same laser system (Poder v Kneip, Osterhoff REF, \cite{Kuschel2018_SELF}) in terms of charge, shot-to-shot stability and maximum energy gain.
