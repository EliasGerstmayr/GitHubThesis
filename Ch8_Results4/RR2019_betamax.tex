...
The following experiment was performed at the Astra Gemini laser facility in early 2019. This particular dataset only used one of the two $800\,\mathrm{nm}$ laser arms available at Gemini laser.

\subsubsection{South beam, electrons and gas target}

The laser is focused down with an f/40 off-axis parabola (OAP) of 6 m focal length onto the edge of a 15 mm conical supersonic helium gas jet target. The laser is linearly polarised in the horizontal plane. The pulse duration of the laser was measured with a FROG diagnostic to be $61\,\mathrm{fs}$  \textsc{fwhm} with an average energy on target of $12.5 \pm 0.2\,\mathrm{J}$, reaching a peak power of $195\,\mathrm{TW}$. The focal spot had the size $48.6 \times 39.2\,\mathrm{\mu m}$. This corresponds to a normalised peak vector potential $a_0$ of $1.88$ in vacuum. A steel razor blade with motorised translation and rotation motion is introduced into the gas flow to induce a shock. The gas flow is characterised by a transverse optical probe split off the main beam ending in a shadowgraphy and a Mach-Zehnder interferometry setup. A DSLR camera is imaging the recombination light of the plasma channel from the side and another camera, also used for aligning the gas target and the razor blade, is imaging the channel from the top. For this dataset the tip of the blade was driven in from the side the laser was entering the plasma up to around $7.5\,\mathrm{mm}$ into the gas jet (half way) at about 4 mm XX NUMBER above the nozzle. The nozzle itself was 14 mm XX NUMBER below the laser axis.

\subsubsection{Electron characterisation}

Relativistic electrons from laser wakefield acceleration (LWFA) and betatron radiation produced in the same process travel further downstream through a $21\,\mathrm{mm}$ diameter aperture in another OAP at $300\,\mathrm{mm}$ distance from the end of the gas jet. The OAP is used in another dataset as part of a colliding-pulse experiment. The laser and electron beam are centred onto the hole and do not interact with the optics. It presents, however, an aperture to high divergence radiation beyond XX NUMBER DIVERGENCE (70 mrad at front, how thick is OAP?), if one includes the thickness of the optic and the mount it is held in.

The electrons are then being dispersed by a large aperture magnet with an integrated field strength $\int B (x) \mathrm{d}x = 0.35 \, \mathrm{Tm}$ in the horizontal plane. Electrons of energies up to 220 MeV hit the inside of the yoke and are not detected. The fan of electrons leaves the vacuum chamber through a wide kevlar-kapton window ($580 \times 70\,\mathrm{mm}$, $25\,\mathrm{\mu m}$ kapton, $375\,\mathrm{\mu m}$ kevlar) and passes through a scintillating Biomax LANEX screen that covers the window from the outside up including the laser axis. Radiation signal on axis can then be used to obtain an on-shot axis reference. The electrons then propagate further in air and pass through another regular LANEX screen after about XX METER distance, with a low energy cut-off at 380 MeV, and are then being dumped into a combined plastic-lead wall that is supposed to help suppressing noise. The cut-off energies are considered for $\pm 10\,\mathrm{mrad}$ and the tracking was done by Dominik Hollatz (Jena), who also designed the magnets.
The LANEX screens are imaged by Andor Neo cameras and the electron energies can be deduced by measuring the field strength and the distances of the magnet and screens carefully. The treatment of the images is detailed can be found in more detail in Jason Cole's thesis REF.

\subsubsection{Characterisation of radiation}

Betatron radiation propagates approximately on laser axis and unperturbed through the magnet in the chamber. The aperture of the magnet permits a field-of-view of XX MRAD (10cm/1m) and is hence less limiting than the OAP hole. On the laser axis a beam block of $10-12$ layers of standard kitchen aluminium foil of thickness $10.1 \pm 0.2 \,\mathrm{\mu m}$ each is attached to the kevlar-kapton window. Hard X-rays continue to propagate through the aluminium beam block and the vacuum window, the LANEX screen that also covers the axis and are then after $700\,\mathrm{mm}$ incident on a $45 \times 45$ array of $1\,\mathrm{mm} \times 1\,\mathrm{mm} \times 10 \,\mathrm{mm}$ scintillating caesium-iodide crystals coated in $TiO_2$ that record the beam profile of the radiation burst. Harder radiation propagates another $704\,\mathrm{mm}$ before hitting another array of caesium-idodide crystals (see Methods for dual axis spectrometer) with an aluminium front-plate that are arranged in longitudinal direction to measure the spectrum of the radiation. The emission of the caesium-iode crystals is imaged by Andor iXon cameras.
...
The interferometry can be used to estimate a density but the fringe spacing might be too coarse to resolve the abrupt change in density.
...
This is work by Cary Colgan and Chris Underwood.

Simulations by Robbie Watt (FLASH).
...
Object & Material & Density/$g/cc$ & Thickness/$\mu m$\\ \hline \hline
Beam block & Aluminium & 2.7 & 100-120\\
Vacuum window & Kapton & 1.42 & 25\\
Vacuum window & Kevlar & 1.44 & 375\\
Lanex screen & Plastic & 1.38 & 178\\
Lanex screen & $Gd_2O_2S$ & 4.25 & 84\\ 
Air & Air & 1.2 & 710.000 \\
Epoxy coating & TiO2 & 4.25 & 500\\ \hline
Gamma Profile & CsI & 4.51 & 10.000 \\
Air & Air & 1.2 & 702.000\\
Front plate & Aluminium & 2.7 & 2.000\\ \hline
Gamma Spec Layer & CsI & 4.51 & 5.000 \\
Spacers & Plastic & xx & 1.000
\end{tabular}
\caption{Materials X-rays have to pass through. The first segment shows the materials the X-rays have to pass through to reach the CsI crystals of the profile screen. The second segment are the materials to pass through until reaching the first crystal layer in the spectral stack. The last segment is what the radiation passes through up to the next layer. Left out Lanex screen components beyond the first two. Also this is for Lanex Fine and not Lanex BioMax but assume it is similar.}
\end{table}
...
\EliasComm{GEANT simulations might not be applicable in this scenario.}
