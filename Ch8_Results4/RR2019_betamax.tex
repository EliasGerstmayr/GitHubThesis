...
Betatron radiation propagates approximately on laser axis and unperturbed through the magnet in the chamber. The aperture of the magnet permits a field-of-view of XX MRAD and is hence less limiting than the OAP hole. On the laser axis a beam block of $10-12$ layers of standard kitchen aluminium foil of thickness $10.1 \pm 0.2 \,\mathrm{\mu m}$ is attached to the kevlar-kapton window. Hard X-rays continue to propagate through the aluminium beam block and the vacuum window, the LANEX screen that also covers the axis and are then incident on a $45 \times 45$ array of $1\,\mathrm{mm} \times 1\,\mathrm{mm} \times 10 \,\mathrm{mm}$ scintillating caesium-iodide crystals that record the beam profile of the radiation burst. Harder radiation propagates another XX DISTANCE before hitting another array of caesium-idodide crystals (see Methods for dual axis spectrometer) that are arranged in longitudinal direction to measure the spectrum of the radiation. The emission of caesium-iode crystals is imaged by Andor iXon cameras.
