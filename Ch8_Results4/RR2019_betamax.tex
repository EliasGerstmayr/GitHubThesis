...
\subsubsection{Closer look at betamax electrons interms of divergence, charge and stability}
...
\subsubsection{Gamma Spec general treatment and simulations (brems) for 2D correction factor.}
...
\subsubsection{Check if GEANT simulations are applicable and if they match transmission.}
